...
def portfolio_change_type(old_num, new_num):
    if new_num < old_num:
        return "portfolio_upgrade"
    return "portfolio_downgrade"
        ...
        if rtype == "CAMPAIGN":
            ...
            if "bidding_strategy" in fields_str:
                ...
                if old_num is not None and new_num is not None and new_num != old_num:
                    record(campaign_name, portfolio_change_type(old_num, new_num), change_date,
            ...
            if "name" in changed_fields:
                ...
                if old_num is not None and new_num is not None and new_num != old_num:
                    record(new_name or campaign_name, portfolio_change_type(old_num, new_num), change_date,
